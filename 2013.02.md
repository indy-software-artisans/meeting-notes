...
## March
* Hard (Left)
  * Dave Fancher - F# (most likely)
* Soft (Right)
  * Jon - "Hacking your job" (tentative title; if time permits)
...
* Raspberry Pi - capabilities, example usages, MAKING LIGHTS BLINK! (Jon/Sasha)
* Netduino stuff (Dean)
...
* Dave Fancher - dynamic programming in .NET?
