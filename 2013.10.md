...
## New Business
* Sasha to ask SEP building people about large meeting spaces for IndyNDA 2.0
* Dean talked to Joe Kuemerle; says December is likely
* Jon to talk to Mark Stetzer about presenting on Big Data

## November
* Fishbowl: Protecting yourself and your data from surveillance
...
## January
* Joe Kuemerle?
* Fallback: December's fallback if unused
* Fallback: Fishbowl on ethics in software development

## February
* Idea: Xbox One and using Project Spark to create a game within it?
